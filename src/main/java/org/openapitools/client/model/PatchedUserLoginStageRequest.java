...
public class PatchedUserLoginStageRequest {
  ...
  public PatchedUserLoginStageRequest() {
  }

  public PatchedUserLoginStageRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PatchedUserLoginStageRequest flowSet(List<FlowSetRequest> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public PatchedUserLoginStageRequest addFlowSetItem(FlowSetRequest flowSetItem) {
  ...
  public PatchedUserLoginStageRequest sessionDuration(String sessionDuration) {
  ...
  public PatchedUserLoginStageRequest terminateOtherSessions(Boolean terminateOtherSessions) {
  ...
  public PatchedUserLoginStageRequest rememberMeOffset(String rememberMeOffset) {
  ...
  public PatchedUserLoginStageRequest networkBinding(NetworkBindingEnum networkBinding) {
  ...
  public PatchedUserLoginStageRequest geoipBinding(GeoipBindingEnum geoipBinding) {
  ...
  public boolean equals(Object o) {
    ...
    PatchedUserLoginStageRequest patchedUserLoginStageRequest = (PatchedUserLoginStageRequest) o;
    return Objects.equals(this.name, patchedUserLoginStageRequest.name) &&
        Objects.equals(this.flowSet, patchedUserLoginStageRequest.flowSet) &&
        Objects.equals(this.sessionDuration, patchedUserLoginStageRequest.sessionDuration) &&
        Objects.equals(this.terminateOtherSessions, patchedUserLoginStageRequest.terminateOtherSessions) &&
        Objects.equals(this.rememberMeOffset, patchedUserLoginStageRequest.rememberMeOffset) &&
        Objects.equals(this.networkBinding, patchedUserLoginStageRequest.networkBinding) &&
        Objects.equals(this.geoipBinding, patchedUserLoginStageRequest.geoipBinding);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedUserLoginStageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchedUserLoginStageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchedUserLoginStageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchedUserLoginStageRequest is not found in the empty JSON string", PatchedUserLoginStageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchedUserLoginStageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchedUserLoginStageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchedUserLoginStageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchedUserLoginStageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchedUserLoginStageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchedUserLoginStageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchedUserLoginStageRequest>() {
           @Override
           public void write(JsonWriter out, PatchedUserLoginStageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchedUserLoginStageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchedUserLoginStageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchedUserLoginStageRequest
   * @throws IOException if the JSON string is invalid with respect to PatchedUserLoginStageRequest
   */
  public static PatchedUserLoginStageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchedUserLoginStageRequest.class);
  }

  /**
   * Convert an instance of PatchedUserLoginStageRequest to an JSON string
   *
   * @return JSON string
   */
