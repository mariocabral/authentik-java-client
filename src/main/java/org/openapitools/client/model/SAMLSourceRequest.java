...
public class SAMLSourceRequest {
  ...
  public SAMLSourceRequest() {
  }

  public SAMLSourceRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SAMLSourceRequest slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public SAMLSourceRequest enabled(Boolean enabled) {
  ...
  public SAMLSourceRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public SAMLSourceRequest enrollmentFlow(UUID enrollmentFlow) {
  ...
  public SAMLSourceRequest policyEngineMode(PolicyEngineMode policyEngineMode) {
  ...
  public SAMLSourceRequest userMatchingMode(UserMatchingModeEnum userMatchingMode) {
  ...
  public SAMLSourceRequest userPathTemplate(String userPathTemplate) {
  ...
  public SAMLSourceRequest preAuthenticationFlow(UUID preAuthenticationFlow) {
  ...
  public SAMLSourceRequest issuer(String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public SAMLSourceRequest ssoUrl(URI ssoUrl) {
    this.ssoUrl = ssoUrl;
    return this;
  }
  ...
  public SAMLSourceRequest sloUrl(URI sloUrl) {
    this.sloUrl = sloUrl;
    return this;
  }
  ...
  public SAMLSourceRequest allowIdpInitiated(Boolean allowIdpInitiated) {
  ...
  public SAMLSourceRequest nameIdPolicy(NameIdPolicyEnum nameIdPolicy) {
  ...
  public SAMLSourceRequest bindingType(BindingTypeEnum bindingType) {
  ...
  public SAMLSourceRequest verificationKp(UUID verificationKp) {
  ...
  public SAMLSourceRequest signingKp(UUID signingKp) {
  ...
  public SAMLSourceRequest digestAlgorithm(DigestAlgorithmEnum digestAlgorithm) {
  ...
  public SAMLSourceRequest signatureAlgorithm(SignatureAlgorithmEnum signatureAlgorithm) {
  ...
  public SAMLSourceRequest temporaryUserDeleteAfter(String temporaryUserDeleteAfter) {
  ...
  public boolean equals(Object o) {
    ...
    SAMLSourceRequest saMLSourceRequest = (SAMLSourceRequest) o;
    return Objects.equals(this.name, saMLSourceRequest.name) &&
        Objects.equals(this.slug, saMLSourceRequest.slug) &&
        Objects.equals(this.enabled, saMLSourceRequest.enabled) &&
        Objects.equals(this.authenticationFlow, saMLSourceRequest.authenticationFlow) &&
        Objects.equals(this.enrollmentFlow, saMLSourceRequest.enrollmentFlow) &&
        Objects.equals(this.policyEngineMode, saMLSourceRequest.policyEngineMode) &&
        Objects.equals(this.userMatchingMode, saMLSourceRequest.userMatchingMode) &&
        Objects.equals(this.userPathTemplate, saMLSourceRequest.userPathTemplate) &&
        Objects.equals(this.preAuthenticationFlow, saMLSourceRequest.preAuthenticationFlow) &&
        Objects.equals(this.issuer, saMLSourceRequest.issuer) &&
        Objects.equals(this.ssoUrl, saMLSourceRequest.ssoUrl) &&
        Objects.equals(this.sloUrl, saMLSourceRequest.sloUrl) &&
        Objects.equals(this.allowIdpInitiated, saMLSourceRequest.allowIdpInitiated) &&
        Objects.equals(this.nameIdPolicy, saMLSourceRequest.nameIdPolicy) &&
        Objects.equals(this.bindingType, saMLSourceRequest.bindingType) &&
        Objects.equals(this.verificationKp, saMLSourceRequest.verificationKp) &&
        Objects.equals(this.signingKp, saMLSourceRequest.signingKp) &&
        Objects.equals(this.digestAlgorithm, saMLSourceRequest.digestAlgorithm) &&
        Objects.equals(this.signatureAlgorithm, saMLSourceRequest.signatureAlgorithm) &&
        Objects.equals(this.temporaryUserDeleteAfter, saMLSourceRequest.temporaryUserDeleteAfter);
  }
  ...
  public String toString() {
    ...
    sb.append("class SAMLSourceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SAMLSourceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SAMLSourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SAMLSourceRequest is not found in the empty JSON string", SAMLSourceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SAMLSourceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SAMLSourceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SAMLSourceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SAMLSourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SAMLSourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SAMLSourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SAMLSourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SAMLSourceRequest>() {
           @Override
           public void write(JsonWriter out, SAMLSourceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SAMLSourceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SAMLSourceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SAMLSourceRequest
   * @throws IOException if the JSON string is invalid with respect to SAMLSourceRequest
   */
  public static SAMLSourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SAMLSourceRequest.class);
  }

  /**
   * Convert an instance of SAMLSourceRequest to an JSON string
   *
   * @return JSON string
   */
