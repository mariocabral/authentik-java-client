...
public class PasswordChallenge {
  ...
  private String component = "ak-stage-password";
  ...
  public PasswordChallenge type(ChallengeChoices type) {
    this.type = type;
    return this;
  }
  ...
  public PasswordChallenge flowInfo(ContextualFlowInfo flowInfo) {
  ...
  public PasswordChallenge component(String component) {
  ...
  public PasswordChallenge responseErrors(Map<String, List<ErrorDetail>> responseErrors) {
    this.responseErrors = responseErrors;
    return this;
  }

  public PasswordChallenge putResponseErrorsItem(String key, List<ErrorDetail> responseErrorsItem) {
  ...
  public PasswordChallenge pendingUser(String pendingUser) {
  ...
  public PasswordChallenge pendingUserAvatar(String pendingUserAvatar) {
  ...
  public PasswordChallenge recoveryUrl(String recoveryUrl) {
  ...
  public boolean equals(Object o) {
    ...
    PasswordChallenge passwordChallenge = (PasswordChallenge) o;
    return Objects.equals(this.type, passwordChallenge.type) &&
        Objects.equals(this.flowInfo, passwordChallenge.flowInfo) &&
        Objects.equals(this.component, passwordChallenge.component) &&
        Objects.equals(this.responseErrors, passwordChallenge.responseErrors) &&
        Objects.equals(this.pendingUser, passwordChallenge.pendingUser) &&
        Objects.equals(this.pendingUserAvatar, passwordChallenge.pendingUserAvatar) &&
        Objects.equals(this.recoveryUrl, passwordChallenge.recoveryUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, flowInfo, component, responseErrors, pendingUser, pendingUserAvatar, recoveryUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PasswordChallenge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PasswordChallenge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasswordChallenge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PasswordChallenge is not found in the empty JSON string", PasswordChallenge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PasswordChallenge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PasswordChallenge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PasswordChallenge.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PasswordChallenge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PasswordChallenge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PasswordChallenge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PasswordChallenge.class));

       return (TypeAdapter<T>) new TypeAdapter<PasswordChallenge>() {
           @Override
           public void write(JsonWriter out, PasswordChallenge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PasswordChallenge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PasswordChallenge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PasswordChallenge
   * @throws IOException if the JSON string is invalid with respect to PasswordChallenge
   */
  public static PasswordChallenge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PasswordChallenge.class);
  }

  /**
   * Convert an instance of PasswordChallenge to an JSON string
   *
   * @return JSON string
   */
