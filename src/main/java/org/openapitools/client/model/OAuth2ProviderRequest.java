...
public class OAuth2ProviderRequest {
  ...
  public OAuth2ProviderRequest() {
  }

  public OAuth2ProviderRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public OAuth2ProviderRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public OAuth2ProviderRequest authorizationFlow(UUID authorizationFlow) {
  ...
  public OAuth2ProviderRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public OAuth2ProviderRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public OAuth2ProviderRequest clientType(ClientTypeEnum clientType) {
  ...
  public OAuth2ProviderRequest clientId(String clientId) {
  ...
  public OAuth2ProviderRequest clientSecret(String clientSecret) {
  ...
  public OAuth2ProviderRequest accessCodeValidity(String accessCodeValidity) {
  ...
  public OAuth2ProviderRequest accessTokenValidity(String accessTokenValidity) {
  ...
  public OAuth2ProviderRequest refreshTokenValidity(String refreshTokenValidity) {
  ...
  public OAuth2ProviderRequest includeClaimsInIdToken(Boolean includeClaimsInIdToken) {
  ...
  public OAuth2ProviderRequest signingKey(UUID signingKey) {
  ...
  public OAuth2ProviderRequest redirectUris(String redirectUris) {
  ...
  public OAuth2ProviderRequest subMode(SubModeEnum subMode) {
  ...
  public OAuth2ProviderRequest issuerMode(IssuerModeEnum issuerMode) {
  ...
  public OAuth2ProviderRequest jwksSources(List<UUID> jwksSources) {
    this.jwksSources = jwksSources;
    return this;
  }

  public OAuth2ProviderRequest addJwksSourcesItem(UUID jwksSourcesItem) {
  ...
  public boolean equals(Object o) {
    ...
    OAuth2ProviderRequest oauth2ProviderRequest = (OAuth2ProviderRequest) o;
    return Objects.equals(this.name, oauth2ProviderRequest.name) &&
        Objects.equals(this.authenticationFlow, oauth2ProviderRequest.authenticationFlow) &&
        Objects.equals(this.authorizationFlow, oauth2ProviderRequest.authorizationFlow) &&
        Objects.equals(this.propertyMappings, oauth2ProviderRequest.propertyMappings) &&
        Objects.equals(this.clientType, oauth2ProviderRequest.clientType) &&
        Objects.equals(this.clientId, oauth2ProviderRequest.clientId) &&
        Objects.equals(this.clientSecret, oauth2ProviderRequest.clientSecret) &&
        Objects.equals(this.accessCodeValidity, oauth2ProviderRequest.accessCodeValidity) &&
        Objects.equals(this.accessTokenValidity, oauth2ProviderRequest.accessTokenValidity) &&
        Objects.equals(this.refreshTokenValidity, oauth2ProviderRequest.refreshTokenValidity) &&
        Objects.equals(this.includeClaimsInIdToken, oauth2ProviderRequest.includeClaimsInIdToken) &&
        Objects.equals(this.signingKey, oauth2ProviderRequest.signingKey) &&
        Objects.equals(this.redirectUris, oauth2ProviderRequest.redirectUris) &&
        Objects.equals(this.subMode, oauth2ProviderRequest.subMode) &&
        Objects.equals(this.issuerMode, oauth2ProviderRequest.issuerMode) &&
        Objects.equals(this.jwksSources, oauth2ProviderRequest.jwksSources);
  }
  ...
  public String toString() {
    ...
    sb.append("class OAuth2ProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OAuth2ProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OAuth2ProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OAuth2ProviderRequest is not found in the empty JSON string", OAuth2ProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OAuth2ProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OAuth2ProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OAuth2ProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OAuth2ProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OAuth2ProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OAuth2ProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OAuth2ProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OAuth2ProviderRequest>() {
           @Override
           public void write(JsonWriter out, OAuth2ProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OAuth2ProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OAuth2ProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OAuth2ProviderRequest
   * @throws IOException if the JSON string is invalid with respect to OAuth2ProviderRequest
   */
  public static OAuth2ProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OAuth2ProviderRequest.class);
  }

  /**
   * Convert an instance of OAuth2ProviderRequest to an JSON string
   *
   * @return JSON string
   */
