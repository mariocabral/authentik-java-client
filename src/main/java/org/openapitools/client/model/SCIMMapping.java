...
public class SCIMMapping {
  ...
  public SCIMMapping managed(String managed) {
  ...
  public SCIMMapping expression(String expression) {
  ...
  public boolean equals(Object o) {
    ...
    SCIMMapping scIMMapping = (SCIMMapping) o;
    return Objects.equals(this.pk, scIMMapping.pk) &&
        Objects.equals(this.managed, scIMMapping.managed) &&
        Objects.equals(this.name, scIMMapping.name) &&
        Objects.equals(this.expression, scIMMapping.expression) &&
        Objects.equals(this.component, scIMMapping.component) &&
        Objects.equals(this.verboseName, scIMMapping.verboseName) &&
        Objects.equals(this.verboseNamePlural, scIMMapping.verboseNamePlural) &&
        Objects.equals(this.metaModelName, scIMMapping.metaModelName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SCIMMapping
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SCIMMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SCIMMapping is not found in the empty JSON string", SCIMMapping.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SCIMMapping.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SCIMMapping` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SCIMMapping.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SCIMMapping.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SCIMMapping' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SCIMMapping> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SCIMMapping.class));

       return (TypeAdapter<T>) new TypeAdapter<SCIMMapping>() {
           @Override
           public void write(JsonWriter out, SCIMMapping value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SCIMMapping read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SCIMMapping given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SCIMMapping
   * @throws IOException if the JSON string is invalid with respect to SCIMMapping
   */
  public static SCIMMapping fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SCIMMapping.class);
  }

  /**
   * Convert an instance of SCIMMapping to an JSON string
   *
   * @return JSON string
   */
