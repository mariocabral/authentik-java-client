...
public class ConsentStage {
  ...
  public ConsentStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ConsentStage flowSet(List<FlowSet> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public ConsentStage addFlowSetItem(FlowSet flowSetItem) {
  ...
  public ConsentStage mode(ConsentStageModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public ConsentStage consentExpireIn(String consentExpireIn) {
  ...
  public boolean equals(Object o) {
    ...
    ConsentStage consentStage = (ConsentStage) o;
    return Objects.equals(this.pk, consentStage.pk) &&
        Objects.equals(this.name, consentStage.name) &&
        Objects.equals(this.component, consentStage.component) &&
        Objects.equals(this.verboseName, consentStage.verboseName) &&
        Objects.equals(this.verboseNamePlural, consentStage.verboseNamePlural) &&
        Objects.equals(this.metaModelName, consentStage.metaModelName) &&
        Objects.equals(this.flowSet, consentStage.flowSet) &&
        Objects.equals(this.mode, consentStage.mode) &&
        Objects.equals(this.consentExpireIn, consentStage.consentExpireIn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pk, name, component, verboseName, verboseNamePlural, metaModelName, flowSet, mode, consentExpireIn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsentStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConsentStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConsentStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsentStage is not found in the empty JSON string", ConsentStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConsentStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConsentStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsentStage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsentStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsentStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsentStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsentStage.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsentStage>() {
           @Override
           public void write(JsonWriter out, ConsentStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConsentStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConsentStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConsentStage
   * @throws IOException if the JSON string is invalid with respect to ConsentStage
   */
  public static ConsentStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsentStage.class);
  }

  /**
   * Convert an instance of ConsentStage to an JSON string
   *
   * @return JSON string
   */
