...
public class PatchedLDAPSourceRequest {
  ...
  public PatchedLDAPSourceRequest() {
  }

  public PatchedLDAPSourceRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PatchedLDAPSourceRequest slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public PatchedLDAPSourceRequest enabled(Boolean enabled) {
  ...
  public PatchedLDAPSourceRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public PatchedLDAPSourceRequest enrollmentFlow(UUID enrollmentFlow) {
  ...
  public PatchedLDAPSourceRequest policyEngineMode(PolicyEngineMode policyEngineMode) {
  ...
  public PatchedLDAPSourceRequest userMatchingMode(UserMatchingModeEnum userMatchingMode) {
  ...
  public PatchedLDAPSourceRequest userPathTemplate(String userPathTemplate) {
  ...
  public PatchedLDAPSourceRequest serverUri(URI serverUri) {
  ...
  public PatchedLDAPSourceRequest peerCertificate(UUID peerCertificate) {
  ...
  public PatchedLDAPSourceRequest clientCertificate(UUID clientCertificate) {
  ...
  public PatchedLDAPSourceRequest bindCn(String bindCn) {
    this.bindCn = bindCn;
    return this;
  }
  ...
  public PatchedLDAPSourceRequest bindPassword(String bindPassword) {
  ...
  public PatchedLDAPSourceRequest startTls(Boolean startTls) {
  ...
  public PatchedLDAPSourceRequest sni(Boolean sni) {
    this.sni = sni;
    return this;
  }
  ...
  public PatchedLDAPSourceRequest baseDn(String baseDn) {
    this.baseDn = baseDn;
    return this;
  }
  ...
  public PatchedLDAPSourceRequest additionalUserDn(String additionalUserDn) {
  ...
  public PatchedLDAPSourceRequest additionalGroupDn(String additionalGroupDn) {
  ...
  public PatchedLDAPSourceRequest userObjectFilter(String userObjectFilter) {
  ...
  public PatchedLDAPSourceRequest groupObjectFilter(String groupObjectFilter) {
  ...
  public PatchedLDAPSourceRequest groupMembershipField(String groupMembershipField) {
  ...
  public PatchedLDAPSourceRequest objectUniquenessField(String objectUniquenessField) {
  ...
  public PatchedLDAPSourceRequest passwordLoginUpdateInternalPassword(Boolean passwordLoginUpdateInternalPassword) {
  ...
  public PatchedLDAPSourceRequest syncUsers(Boolean syncUsers) {
  ...
  public PatchedLDAPSourceRequest syncUsersPassword(Boolean syncUsersPassword) {
  ...
  public PatchedLDAPSourceRequest syncGroups(Boolean syncGroups) {
  ...
  public PatchedLDAPSourceRequest syncParentGroup(UUID syncParentGroup) {
  ...
  public PatchedLDAPSourceRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public PatchedLDAPSourceRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public PatchedLDAPSourceRequest propertyMappingsGroup(List<UUID> propertyMappingsGroup) {
    this.propertyMappingsGroup = propertyMappingsGroup;
    return this;
  }

  public PatchedLDAPSourceRequest addPropertyMappingsGroupItem(UUID propertyMappingsGroupItem) {
  ...
  public boolean equals(Object o) {
    ...
    PatchedLDAPSourceRequest patchedLDAPSourceRequest = (PatchedLDAPSourceRequest) o;
    return Objects.equals(this.name, patchedLDAPSourceRequest.name) &&
        Objects.equals(this.slug, patchedLDAPSourceRequest.slug) &&
        Objects.equals(this.enabled, patchedLDAPSourceRequest.enabled) &&
        Objects.equals(this.authenticationFlow, patchedLDAPSourceRequest.authenticationFlow) &&
        Objects.equals(this.enrollmentFlow, patchedLDAPSourceRequest.enrollmentFlow) &&
        Objects.equals(this.policyEngineMode, patchedLDAPSourceRequest.policyEngineMode) &&
        Objects.equals(this.userMatchingMode, patchedLDAPSourceRequest.userMatchingMode) &&
        Objects.equals(this.userPathTemplate, patchedLDAPSourceRequest.userPathTemplate) &&
        Objects.equals(this.serverUri, patchedLDAPSourceRequest.serverUri) &&
        Objects.equals(this.peerCertificate, patchedLDAPSourceRequest.peerCertificate) &&
        Objects.equals(this.clientCertificate, patchedLDAPSourceRequest.clientCertificate) &&
        Objects.equals(this.bindCn, patchedLDAPSourceRequest.bindCn) &&
        Objects.equals(this.bindPassword, patchedLDAPSourceRequest.bindPassword) &&
        Objects.equals(this.startTls, patchedLDAPSourceRequest.startTls) &&
        Objects.equals(this.sni, patchedLDAPSourceRequest.sni) &&
        Objects.equals(this.baseDn, patchedLDAPSourceRequest.baseDn) &&
        Objects.equals(this.additionalUserDn, patchedLDAPSourceRequest.additionalUserDn) &&
        Objects.equals(this.additionalGroupDn, patchedLDAPSourceRequest.additionalGroupDn) &&
        Objects.equals(this.userObjectFilter, patchedLDAPSourceRequest.userObjectFilter) &&
        Objects.equals(this.groupObjectFilter, patchedLDAPSourceRequest.groupObjectFilter) &&
        Objects.equals(this.groupMembershipField, patchedLDAPSourceRequest.groupMembershipField) &&
        Objects.equals(this.objectUniquenessField, patchedLDAPSourceRequest.objectUniquenessField) &&
        Objects.equals(this.passwordLoginUpdateInternalPassword, patchedLDAPSourceRequest.passwordLoginUpdateInternalPassword) &&
        Objects.equals(this.syncUsers, patchedLDAPSourceRequest.syncUsers) &&
        Objects.equals(this.syncUsersPassword, patchedLDAPSourceRequest.syncUsersPassword) &&
        Objects.equals(this.syncGroups, patchedLDAPSourceRequest.syncGroups) &&
        Objects.equals(this.syncParentGroup, patchedLDAPSourceRequest.syncParentGroup) &&
        Objects.equals(this.propertyMappings, patchedLDAPSourceRequest.propertyMappings) &&
        Objects.equals(this.propertyMappingsGroup, patchedLDAPSourceRequest.propertyMappingsGroup);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedLDAPSourceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchedLDAPSourceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchedLDAPSourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchedLDAPSourceRequest is not found in the empty JSON string", PatchedLDAPSourceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchedLDAPSourceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchedLDAPSourceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("server_uri") != null && !jsonObj.get("server_uri").isJsonNull()) && !jsonObj.get("server_uri").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchedLDAPSourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchedLDAPSourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchedLDAPSourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchedLDAPSourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchedLDAPSourceRequest>() {
           @Override
           public void write(JsonWriter out, PatchedLDAPSourceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchedLDAPSourceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchedLDAPSourceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchedLDAPSourceRequest
   * @throws IOException if the JSON string is invalid with respect to PatchedLDAPSourceRequest
   */
  public static PatchedLDAPSourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchedLDAPSourceRequest.class);
  }

  /**
   * Convert an instance of PatchedLDAPSourceRequest to an JSON string
   *
   * @return JSON string
   */
