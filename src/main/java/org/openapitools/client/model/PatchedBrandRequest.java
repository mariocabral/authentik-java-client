...
public class PatchedBrandRequest {
  ...
  public PatchedBrandRequest() {
  }

  public PatchedBrandRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public PatchedBrandRequest _default(Boolean _default) {
  ...
  public PatchedBrandRequest brandingTitle(String brandingTitle) {
  ...
  public PatchedBrandRequest brandingLogo(String brandingLogo) {
  ...
  public PatchedBrandRequest brandingFavicon(String brandingFavicon) {
  ...
  public PatchedBrandRequest flowAuthentication(UUID flowAuthentication) {
  ...
  public PatchedBrandRequest flowInvalidation(UUID flowInvalidation) {
  ...
  public PatchedBrandRequest flowRecovery(UUID flowRecovery) {
  ...
  public PatchedBrandRequest flowUnenrollment(UUID flowUnenrollment) {
  ...
  public PatchedBrandRequest flowUserSettings(UUID flowUserSettings) {
  ...
  public PatchedBrandRequest flowDeviceCode(UUID flowDeviceCode) {
  ...
  public PatchedBrandRequest webCertificate(UUID webCertificate) {
  ...
  public PatchedBrandRequest attributes(Object attributes) {
  ...
  public boolean equals(Object o) {
    ...
    PatchedBrandRequest patchedBrandRequest = (PatchedBrandRequest) o;
    return Objects.equals(this.domain, patchedBrandRequest.domain) &&
        Objects.equals(this._default, patchedBrandRequest._default) &&
        Objects.equals(this.brandingTitle, patchedBrandRequest.brandingTitle) &&
        Objects.equals(this.brandingLogo, patchedBrandRequest.brandingLogo) &&
        Objects.equals(this.brandingFavicon, patchedBrandRequest.brandingFavicon) &&
        Objects.equals(this.flowAuthentication, patchedBrandRequest.flowAuthentication) &&
        Objects.equals(this.flowInvalidation, patchedBrandRequest.flowInvalidation) &&
        Objects.equals(this.flowRecovery, patchedBrandRequest.flowRecovery) &&
        Objects.equals(this.flowUnenrollment, patchedBrandRequest.flowUnenrollment) &&
        Objects.equals(this.flowUserSettings, patchedBrandRequest.flowUserSettings) &&
        Objects.equals(this.flowDeviceCode, patchedBrandRequest.flowDeviceCode) &&
        Objects.equals(this.webCertificate, patchedBrandRequest.webCertificate) &&
        Objects.equals(this.attributes, patchedBrandRequest.attributes);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(domain, _default, brandingTitle, brandingLogo, brandingFavicon, flowAuthentication, flowInvalidation, flowRecovery, flowUnenrollment, flowUserSettings, flowDeviceCode, webCertificate, attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedBrandRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchedBrandRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchedBrandRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchedBrandRequest is not found in the empty JSON string", PatchedBrandRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchedBrandRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchedBrandRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchedBrandRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchedBrandRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchedBrandRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchedBrandRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchedBrandRequest>() {
           @Override
           public void write(JsonWriter out, PatchedBrandRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchedBrandRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchedBrandRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchedBrandRequest
   * @throws IOException if the JSON string is invalid with respect to PatchedBrandRequest
   */
  public static PatchedBrandRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchedBrandRequest.class);
  }

  /**
   * Convert an instance of PatchedBrandRequest to an JSON string
   *
   * @return JSON string
   */
