...
public class GoogleWorkspaceProviderRequest {
  ...
  public GoogleWorkspaceProviderRequest() {
  }

  public GoogleWorkspaceProviderRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleWorkspaceProviderRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public GoogleWorkspaceProviderRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public GoogleWorkspaceProviderRequest propertyMappingsGroup(List<UUID> propertyMappingsGroup) {
    this.propertyMappingsGroup = propertyMappingsGroup;
    return this;
  }

  public GoogleWorkspaceProviderRequest addPropertyMappingsGroupItem(UUID propertyMappingsGroupItem) {
  ...
  public GoogleWorkspaceProviderRequest delegatedSubject(String delegatedSubject) {
  ...
  public GoogleWorkspaceProviderRequest credentials(Object credentials) {
  ...
  public GoogleWorkspaceProviderRequest scopes(String scopes) {
    this.scopes = scopes;
    return this;
  }
  ...
  public GoogleWorkspaceProviderRequest excludeUsersServiceAccount(Boolean excludeUsersServiceAccount) {
  ...
  public GoogleWorkspaceProviderRequest filterGroup(UUID filterGroup) {
  ...
  public GoogleWorkspaceProviderRequest userDeleteAction(OutgoingSyncDeleteAction userDeleteAction) {
  ...
  public GoogleWorkspaceProviderRequest groupDeleteAction(OutgoingSyncDeleteAction groupDeleteAction) {
  ...
  public GoogleWorkspaceProviderRequest defaultGroupEmailDomain(String defaultGroupEmailDomain) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleWorkspaceProviderRequest googleWorkspaceProviderRequest = (GoogleWorkspaceProviderRequest) o;
    return Objects.equals(this.name, googleWorkspaceProviderRequest.name) &&
        Objects.equals(this.propertyMappings, googleWorkspaceProviderRequest.propertyMappings) &&
        Objects.equals(this.propertyMappingsGroup, googleWorkspaceProviderRequest.propertyMappingsGroup) &&
        Objects.equals(this.delegatedSubject, googleWorkspaceProviderRequest.delegatedSubject) &&
        Objects.equals(this.credentials, googleWorkspaceProviderRequest.credentials) &&
        Objects.equals(this.scopes, googleWorkspaceProviderRequest.scopes) &&
        Objects.equals(this.excludeUsersServiceAccount, googleWorkspaceProviderRequest.excludeUsersServiceAccount) &&
        Objects.equals(this.filterGroup, googleWorkspaceProviderRequest.filterGroup) &&
        Objects.equals(this.userDeleteAction, googleWorkspaceProviderRequest.userDeleteAction) &&
        Objects.equals(this.groupDeleteAction, googleWorkspaceProviderRequest.groupDeleteAction) &&
        Objects.equals(this.defaultGroupEmailDomain, googleWorkspaceProviderRequest.defaultGroupEmailDomain);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleWorkspaceProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleWorkspaceProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleWorkspaceProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleWorkspaceProviderRequest is not found in the empty JSON string", GoogleWorkspaceProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleWorkspaceProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleWorkspaceProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GoogleWorkspaceProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleWorkspaceProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleWorkspaceProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleWorkspaceProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleWorkspaceProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleWorkspaceProviderRequest>() {
           @Override
           public void write(JsonWriter out, GoogleWorkspaceProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleWorkspaceProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleWorkspaceProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleWorkspaceProviderRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleWorkspaceProviderRequest
   */
  public static GoogleWorkspaceProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleWorkspaceProviderRequest.class);
  }

  /**
   * Convert an instance of GoogleWorkspaceProviderRequest to an JSON string
   *
   * @return JSON string
   */
