...
public class ProxyProviderRequest {
  ...
  public ProxyProviderRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProxyProviderRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public ProxyProviderRequest authorizationFlow(UUID authorizationFlow) {
  ...
  public ProxyProviderRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public ProxyProviderRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public ProxyProviderRequest internalHost(URI internalHost) {
  ...
  public ProxyProviderRequest externalHost(URI externalHost) {
  ...
  public ProxyProviderRequest internalHostSslValidation(Boolean internalHostSslValidation) {
  ...
  public ProxyProviderRequest certificate(UUID certificate) {
  ...
  public ProxyProviderRequest skipPathRegex(String skipPathRegex) {
  ...
  public ProxyProviderRequest basicAuthEnabled(Boolean basicAuthEnabled) {
  ...
  public ProxyProviderRequest basicAuthPasswordAttribute(String basicAuthPasswordAttribute) {
  ...
  public ProxyProviderRequest basicAuthUserAttribute(String basicAuthUserAttribute) {
  ...
  public ProxyProviderRequest mode(ProxyMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public ProxyProviderRequest interceptHeaderAuth(Boolean interceptHeaderAuth) {
  ...
  public ProxyProviderRequest cookieDomain(String cookieDomain) {
  ...
  public ProxyProviderRequest jwksSources(List<UUID> jwksSources) {
    this.jwksSources = jwksSources;
    return this;
  }

  public ProxyProviderRequest addJwksSourcesItem(UUID jwksSourcesItem) {
  ...
  public ProxyProviderRequest accessTokenValidity(String accessTokenValidity) {
  ...
  public ProxyProviderRequest refreshTokenValidity(String refreshTokenValidity) {
  ...
  public boolean equals(Object o) {
    ...
    ProxyProviderRequest proxyProviderRequest = (ProxyProviderRequest) o;
    return Objects.equals(this.name, proxyProviderRequest.name) &&
        Objects.equals(this.authenticationFlow, proxyProviderRequest.authenticationFlow) &&
        Objects.equals(this.authorizationFlow, proxyProviderRequest.authorizationFlow) &&
        Objects.equals(this.propertyMappings, proxyProviderRequest.propertyMappings) &&
        Objects.equals(this.internalHost, proxyProviderRequest.internalHost) &&
        Objects.equals(this.externalHost, proxyProviderRequest.externalHost) &&
        Objects.equals(this.internalHostSslValidation, proxyProviderRequest.internalHostSslValidation) &&
        Objects.equals(this.certificate, proxyProviderRequest.certificate) &&
        Objects.equals(this.skipPathRegex, proxyProviderRequest.skipPathRegex) &&
        Objects.equals(this.basicAuthEnabled, proxyProviderRequest.basicAuthEnabled) &&
        Objects.equals(this.basicAuthPasswordAttribute, proxyProviderRequest.basicAuthPasswordAttribute) &&
        Objects.equals(this.basicAuthUserAttribute, proxyProviderRequest.basicAuthUserAttribute) &&
        Objects.equals(this.mode, proxyProviderRequest.mode) &&
        Objects.equals(this.interceptHeaderAuth, proxyProviderRequest.interceptHeaderAuth) &&
        Objects.equals(this.cookieDomain, proxyProviderRequest.cookieDomain) &&
        Objects.equals(this.jwksSources, proxyProviderRequest.jwksSources) &&
        Objects.equals(this.accessTokenValidity, proxyProviderRequest.accessTokenValidity) &&
        Objects.equals(this.refreshTokenValidity, proxyProviderRequest.refreshTokenValidity);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProxyProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProxyProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProxyProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyProviderRequest is not found in the empty JSON string", ProxyProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProxyProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProxyProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProxyProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyProviderRequest>() {
           @Override
           public void write(JsonWriter out, ProxyProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProxyProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProxyProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProxyProviderRequest
   * @throws IOException if the JSON string is invalid with respect to ProxyProviderRequest
   */
  public static ProxyProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyProviderRequest.class);
  }

  /**
   * Convert an instance of ProxyProviderRequest to an JSON string
   *
   * @return JSON string
   */
