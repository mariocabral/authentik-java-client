...
public class SettingsRequest {
  ...
  public SettingsRequest avatars(String avatars) {
  ...
  public SettingsRequest defaultUserChangeName(Boolean defaultUserChangeName) {
  ...
  public SettingsRequest defaultUserChangeEmail(Boolean defaultUserChangeEmail) {
  ...
  public SettingsRequest defaultUserChangeUsername(Boolean defaultUserChangeUsername) {
  ...
  public SettingsRequest eventRetention(String eventRetention) {
  ...
  public SettingsRequest footerLinks(Object footerLinks) {
  ...
  public SettingsRequest gdprCompliance(Boolean gdprCompliance) {
  ...
  public SettingsRequest impersonation(Boolean impersonation) {
  ...
  public SettingsRequest defaultTokenDuration(String defaultTokenDuration) {
  ...
  public SettingsRequest defaultTokenLength(Integer defaultTokenLength) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatars, settingsRequest.avatars) &&
        Objects.equals(this.defaultUserChangeName, settingsRequest.defaultUserChangeName) &&
        Objects.equals(this.defaultUserChangeEmail, settingsRequest.defaultUserChangeEmail) &&
        Objects.equals(this.defaultUserChangeUsername, settingsRequest.defaultUserChangeUsername) &&
        Objects.equals(this.eventRetention, settingsRequest.eventRetention) &&
        Objects.equals(this.footerLinks, settingsRequest.footerLinks) &&
        Objects.equals(this.gdprCompliance, settingsRequest.gdprCompliance) &&
        Objects.equals(this.impersonation, settingsRequest.impersonation) &&
        Objects.equals(this.defaultTokenDuration, settingsRequest.defaultTokenDuration) &&
        Objects.equals(this.defaultTokenLength, settingsRequest.defaultTokenLength);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SettingsRequest is not found in the empty JSON string", SettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SettingsRequest>() {
           @Override
           public void write(JsonWriter out, SettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SettingsRequest
   * @throws IOException if the JSON string is invalid with respect to SettingsRequest
   */
  public static SettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SettingsRequest.class);
  }

  /**
   * Convert an instance of SettingsRequest to an JSON string
   *
   * @return JSON string
   */
