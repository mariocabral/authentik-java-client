...
public class RACProviderRequest {
  ...
  public RACProviderRequest() {
  }

  public RACProviderRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RACProviderRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public RACProviderRequest authorizationFlow(UUID authorizationFlow) {
  ...
  public RACProviderRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public RACProviderRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public RACProviderRequest settings(Object settings) {
  ...
  public RACProviderRequest connectionExpiry(String connectionExpiry) {
  ...
  public RACProviderRequest deleteTokenOnDisconnect(Boolean deleteTokenOnDisconnect) {
  ...
  public boolean equals(Object o) {
    ...
    RACProviderRequest raCProviderRequest = (RACProviderRequest) o;
    return Objects.equals(this.name, raCProviderRequest.name) &&
        Objects.equals(this.authenticationFlow, raCProviderRequest.authenticationFlow) &&
        Objects.equals(this.authorizationFlow, raCProviderRequest.authorizationFlow) &&
        Objects.equals(this.propertyMappings, raCProviderRequest.propertyMappings) &&
        Objects.equals(this.settings, raCProviderRequest.settings) &&
        Objects.equals(this.connectionExpiry, raCProviderRequest.connectionExpiry) &&
        Objects.equals(this.deleteTokenOnDisconnect, raCProviderRequest.deleteTokenOnDisconnect);
  }
  ...
  public String toString() {
    ...
    sb.append("class RACProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RACProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RACProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RACProviderRequest is not found in the empty JSON string", RACProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RACProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RACProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RACProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RACProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RACProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RACProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RACProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RACProviderRequest>() {
           @Override
           public void write(JsonWriter out, RACProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RACProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RACProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RACProviderRequest
   * @throws IOException if the JSON string is invalid with respect to RACProviderRequest
   */
  public static RACProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RACProviderRequest.class);
  }

  /**
   * Convert an instance of RACProviderRequest to an JSON string
   *
   * @return JSON string
   */
