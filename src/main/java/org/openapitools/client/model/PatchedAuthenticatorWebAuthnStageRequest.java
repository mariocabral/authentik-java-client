...
public class PatchedAuthenticatorWebAuthnStageRequest {
  ...
  public PatchedAuthenticatorWebAuthnStageRequest() {
  }

  public PatchedAuthenticatorWebAuthnStageRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PatchedAuthenticatorWebAuthnStageRequest flowSet(List<FlowSetRequest> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public PatchedAuthenticatorWebAuthnStageRequest addFlowSetItem(FlowSetRequest flowSetItem) {
  ...
  public PatchedAuthenticatorWebAuthnStageRequest configureFlow(UUID configureFlow) {
  ...
  public PatchedAuthenticatorWebAuthnStageRequest friendlyName(String friendlyName) {
  ...
  public PatchedAuthenticatorWebAuthnStageRequest userVerification(UserVerificationEnum userVerification) {
  ...
  public PatchedAuthenticatorWebAuthnStageRequest authenticatorAttachment(AuthenticatorAttachmentEnum authenticatorAttachment) {
  ...
  public PatchedAuthenticatorWebAuthnStageRequest residentKeyRequirement(ResidentKeyRequirementEnum residentKeyRequirement) {
  ...
  public PatchedAuthenticatorWebAuthnStageRequest deviceTypeRestrictions(List<UUID> deviceTypeRestrictions) {
    this.deviceTypeRestrictions = deviceTypeRestrictions;
    return this;
  }

  public PatchedAuthenticatorWebAuthnStageRequest addDeviceTypeRestrictionsItem(UUID deviceTypeRestrictionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PatchedAuthenticatorWebAuthnStageRequest patchedAuthenticatorWebAuthnStageRequest = (PatchedAuthenticatorWebAuthnStageRequest) o;
    return Objects.equals(this.name, patchedAuthenticatorWebAuthnStageRequest.name) &&
        Objects.equals(this.flowSet, patchedAuthenticatorWebAuthnStageRequest.flowSet) &&
        Objects.equals(this.configureFlow, patchedAuthenticatorWebAuthnStageRequest.configureFlow) &&
        Objects.equals(this.friendlyName, patchedAuthenticatorWebAuthnStageRequest.friendlyName) &&
        Objects.equals(this.userVerification, patchedAuthenticatorWebAuthnStageRequest.userVerification) &&
        Objects.equals(this.authenticatorAttachment, patchedAuthenticatorWebAuthnStageRequest.authenticatorAttachment) &&
        Objects.equals(this.residentKeyRequirement, patchedAuthenticatorWebAuthnStageRequest.residentKeyRequirement) &&
        Objects.equals(this.deviceTypeRestrictions, patchedAuthenticatorWebAuthnStageRequest.deviceTypeRestrictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedAuthenticatorWebAuthnStageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchedAuthenticatorWebAuthnStageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchedAuthenticatorWebAuthnStageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchedAuthenticatorWebAuthnStageRequest is not found in the empty JSON string", PatchedAuthenticatorWebAuthnStageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchedAuthenticatorWebAuthnStageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchedAuthenticatorWebAuthnStageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchedAuthenticatorWebAuthnStageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchedAuthenticatorWebAuthnStageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchedAuthenticatorWebAuthnStageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchedAuthenticatorWebAuthnStageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchedAuthenticatorWebAuthnStageRequest>() {
           @Override
           public void write(JsonWriter out, PatchedAuthenticatorWebAuthnStageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchedAuthenticatorWebAuthnStageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchedAuthenticatorWebAuthnStageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchedAuthenticatorWebAuthnStageRequest
   * @throws IOException if the JSON string is invalid with respect to PatchedAuthenticatorWebAuthnStageRequest
   */
  public static PatchedAuthenticatorWebAuthnStageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchedAuthenticatorWebAuthnStageRequest.class);
  }

  /**
   * Convert an instance of PatchedAuthenticatorWebAuthnStageRequest to an JSON string
   *
   * @return JSON string
   */
