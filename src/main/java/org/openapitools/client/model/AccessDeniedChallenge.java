...
public class AccessDeniedChallenge {
  ...
  private String component = "ak-stage-access-denied";
  ...
  public AccessDeniedChallenge() {
  }

  public AccessDeniedChallenge type(ChallengeChoices type) {
    this.type = type;
    return this;
  }
  ...
  public AccessDeniedChallenge flowInfo(ContextualFlowInfo flowInfo) {
  ...
  public AccessDeniedChallenge component(String component) {
  ...
  public AccessDeniedChallenge responseErrors(Map<String, List<ErrorDetail>> responseErrors) {
    this.responseErrors = responseErrors;
    return this;
  }

  public AccessDeniedChallenge putResponseErrorsItem(String key, List<ErrorDetail> responseErrorsItem) {
  ...
  public AccessDeniedChallenge pendingUser(String pendingUser) {
  ...
  public AccessDeniedChallenge pendingUserAvatar(String pendingUserAvatar) {
  ...
  public AccessDeniedChallenge errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    AccessDeniedChallenge accessDeniedChallenge = (AccessDeniedChallenge) o;
    return Objects.equals(this.type, accessDeniedChallenge.type) &&
        Objects.equals(this.flowInfo, accessDeniedChallenge.flowInfo) &&
        Objects.equals(this.component, accessDeniedChallenge.component) &&
        Objects.equals(this.responseErrors, accessDeniedChallenge.responseErrors) &&
        Objects.equals(this.pendingUser, accessDeniedChallenge.pendingUser) &&
        Objects.equals(this.pendingUserAvatar, accessDeniedChallenge.pendingUserAvatar) &&
        Objects.equals(this.errorMessage, accessDeniedChallenge.errorMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, flowInfo, component, responseErrors, pendingUser, pendingUserAvatar, errorMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccessDeniedChallenge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessDeniedChallenge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessDeniedChallenge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessDeniedChallenge is not found in the empty JSON string", AccessDeniedChallenge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessDeniedChallenge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessDeniedChallenge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessDeniedChallenge.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessDeniedChallenge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessDeniedChallenge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessDeniedChallenge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessDeniedChallenge.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessDeniedChallenge>() {
           @Override
           public void write(JsonWriter out, AccessDeniedChallenge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessDeniedChallenge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccessDeniedChallenge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessDeniedChallenge
   * @throws IOException if the JSON string is invalid with respect to AccessDeniedChallenge
   */
  public static AccessDeniedChallenge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessDeniedChallenge.class);
  }

  /**
   * Convert an instance of AccessDeniedChallenge to an JSON string
   *
   * @return JSON string
   */
