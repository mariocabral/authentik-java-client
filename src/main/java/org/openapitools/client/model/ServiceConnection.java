...
public class ServiceConnection {
  ...
  public ServiceConnection local(Boolean local) {
    this.local = local;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pk, serviceConnection.pk) &&
        Objects.equals(this.name, serviceConnection.name) &&
        Objects.equals(this.local, serviceConnection.local) &&
        Objects.equals(this.component, serviceConnection.component) &&
        Objects.equals(this.verboseName, serviceConnection.verboseName) &&
        Objects.equals(this.verboseNamePlural, serviceConnection.verboseNamePlural) &&
        Objects.equals(this.metaModelName, serviceConnection.metaModelName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pk, name, local, component, verboseName, verboseNamePlural, metaModelName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceConnection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceConnection is not found in the empty JSON string", ServiceConnection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceConnection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceConnection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServiceConnection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceConnection>() {
           @Override
           public void write(JsonWriter out, ServiceConnection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceConnection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceConnection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceConnection
   * @throws IOException if the JSON string is invalid with respect to ServiceConnection
   */
  public static ServiceConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceConnection.class);
  }

  /**
   * Convert an instance of ServiceConnection to an JSON string
   *
   * @return JSON string
   */
