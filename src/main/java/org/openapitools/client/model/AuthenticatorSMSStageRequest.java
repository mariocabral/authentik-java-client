...
public class AuthenticatorSMSStageRequest {
  ...
  public AuthenticatorSMSStageRequest() {
  }

  public AuthenticatorSMSStageRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthenticatorSMSStageRequest flowSet(List<FlowSetRequest> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public AuthenticatorSMSStageRequest addFlowSetItem(FlowSetRequest flowSetItem) {
  ...
  public AuthenticatorSMSStageRequest configureFlow(UUID configureFlow) {
  ...
  public AuthenticatorSMSStageRequest friendlyName(String friendlyName) {
  ...
  public AuthenticatorSMSStageRequest provider(ProviderEnum provider) {
  ...
  public AuthenticatorSMSStageRequest fromNumber(String fromNumber) {
  ...
  public AuthenticatorSMSStageRequest accountSid(String accountSid) {
  ...
  public AuthenticatorSMSStageRequest auth(String auth) {
    this.auth = auth;
    return this;
  }
  ...
  public AuthenticatorSMSStageRequest authPassword(String authPassword) {
  ...
  public AuthenticatorSMSStageRequest authType(AuthTypeEnum authType) {
  ...
  public AuthenticatorSMSStageRequest verifyOnly(Boolean verifyOnly) {
  ...
  public AuthenticatorSMSStageRequest mapping(UUID mapping) {
  ...
  public boolean equals(Object o) {
    ...
    AuthenticatorSMSStageRequest authenticatorSMSStageRequest = (AuthenticatorSMSStageRequest) o;
    return Objects.equals(this.name, authenticatorSMSStageRequest.name) &&
        Objects.equals(this.flowSet, authenticatorSMSStageRequest.flowSet) &&
        Objects.equals(this.configureFlow, authenticatorSMSStageRequest.configureFlow) &&
        Objects.equals(this.friendlyName, authenticatorSMSStageRequest.friendlyName) &&
        Objects.equals(this.provider, authenticatorSMSStageRequest.provider) &&
        Objects.equals(this.fromNumber, authenticatorSMSStageRequest.fromNumber) &&
        Objects.equals(this.accountSid, authenticatorSMSStageRequest.accountSid) &&
        Objects.equals(this.auth, authenticatorSMSStageRequest.auth) &&
        Objects.equals(this.authPassword, authenticatorSMSStageRequest.authPassword) &&
        Objects.equals(this.authType, authenticatorSMSStageRequest.authType) &&
        Objects.equals(this.verifyOnly, authenticatorSMSStageRequest.verifyOnly) &&
        Objects.equals(this.mapping, authenticatorSMSStageRequest.mapping);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticatorSMSStageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthenticatorSMSStageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticatorSMSStageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthenticatorSMSStageRequest is not found in the empty JSON string", AuthenticatorSMSStageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticatorSMSStageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthenticatorSMSStageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthenticatorSMSStageRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthenticatorSMSStageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthenticatorSMSStageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthenticatorSMSStageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthenticatorSMSStageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthenticatorSMSStageRequest>() {
           @Override
           public void write(JsonWriter out, AuthenticatorSMSStageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthenticatorSMSStageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthenticatorSMSStageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthenticatorSMSStageRequest
   * @throws IOException if the JSON string is invalid with respect to AuthenticatorSMSStageRequest
   */
  public static AuthenticatorSMSStageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthenticatorSMSStageRequest.class);
  }

  /**
   * Convert an instance of AuthenticatorSMSStageRequest to an JSON string
   *
   * @return JSON string
   */
