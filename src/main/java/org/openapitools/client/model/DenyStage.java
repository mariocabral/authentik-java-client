...
public class DenyStage {
  ...
  public DenyStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DenyStage flowSet(List<FlowSet> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public DenyStage addFlowSetItem(FlowSet flowSetItem) {
  ...
  public DenyStage denyMessage(String denyMessage) {
  ...
  public boolean equals(Object o) {
    ...
    DenyStage denyStage = (DenyStage) o;
    return Objects.equals(this.pk, denyStage.pk) &&
        Objects.equals(this.name, denyStage.name) &&
        Objects.equals(this.component, denyStage.component) &&
        Objects.equals(this.verboseName, denyStage.verboseName) &&
        Objects.equals(this.verboseNamePlural, denyStage.verboseNamePlural) &&
        Objects.equals(this.metaModelName, denyStage.metaModelName) &&
        Objects.equals(this.flowSet, denyStage.flowSet) &&
        Objects.equals(this.denyMessage, denyStage.denyMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pk, name, component, verboseName, verboseNamePlural, metaModelName, flowSet, denyMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DenyStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DenyStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DenyStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DenyStage is not found in the empty JSON string", DenyStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DenyStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DenyStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DenyStage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DenyStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DenyStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DenyStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DenyStage.class));

       return (TypeAdapter<T>) new TypeAdapter<DenyStage>() {
           @Override
           public void write(JsonWriter out, DenyStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DenyStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DenyStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DenyStage
   * @throws IOException if the JSON string is invalid with respect to DenyStage
   */
  public static DenyStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DenyStage.class);
  }

  /**
   * Convert an instance of DenyStage to an JSON string
   *
   * @return JSON string
   */
