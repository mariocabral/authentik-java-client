...
public class AuthenticatorDuoStageRequest {
  ...
  public AuthenticatorDuoStageRequest() {
  }

  public AuthenticatorDuoStageRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthenticatorDuoStageRequest flowSet(List<FlowSetRequest> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public AuthenticatorDuoStageRequest addFlowSetItem(FlowSetRequest flowSetItem) {
  ...
  public AuthenticatorDuoStageRequest configureFlow(UUID configureFlow) {
  ...
  public AuthenticatorDuoStageRequest friendlyName(String friendlyName) {
  ...
  public AuthenticatorDuoStageRequest clientId(String clientId) {
  ...
  public AuthenticatorDuoStageRequest clientSecret(String clientSecret) {
  ...
  public AuthenticatorDuoStageRequest apiHostname(String apiHostname) {
  ...
  public AuthenticatorDuoStageRequest adminIntegrationKey(String adminIntegrationKey) {
  ...
  public AuthenticatorDuoStageRequest adminSecretKey(String adminSecretKey) {
  ...
  public boolean equals(Object o) {
    ...
    AuthenticatorDuoStageRequest authenticatorDuoStageRequest = (AuthenticatorDuoStageRequest) o;
    return Objects.equals(this.name, authenticatorDuoStageRequest.name) &&
        Objects.equals(this.flowSet, authenticatorDuoStageRequest.flowSet) &&
        Objects.equals(this.configureFlow, authenticatorDuoStageRequest.configureFlow) &&
        Objects.equals(this.friendlyName, authenticatorDuoStageRequest.friendlyName) &&
        Objects.equals(this.clientId, authenticatorDuoStageRequest.clientId) &&
        Objects.equals(this.clientSecret, authenticatorDuoStageRequest.clientSecret) &&
        Objects.equals(this.apiHostname, authenticatorDuoStageRequest.apiHostname) &&
        Objects.equals(this.adminIntegrationKey, authenticatorDuoStageRequest.adminIntegrationKey) &&
        Objects.equals(this.adminSecretKey, authenticatorDuoStageRequest.adminSecretKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticatorDuoStageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthenticatorDuoStageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticatorDuoStageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthenticatorDuoStageRequest is not found in the empty JSON string", AuthenticatorDuoStageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticatorDuoStageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthenticatorDuoStageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthenticatorDuoStageRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthenticatorDuoStageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthenticatorDuoStageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthenticatorDuoStageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthenticatorDuoStageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthenticatorDuoStageRequest>() {
           @Override
           public void write(JsonWriter out, AuthenticatorDuoStageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthenticatorDuoStageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthenticatorDuoStageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthenticatorDuoStageRequest
   * @throws IOException if the JSON string is invalid with respect to AuthenticatorDuoStageRequest
   */
  public static AuthenticatorDuoStageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthenticatorDuoStageRequest.class);
  }

  /**
   * Convert an instance of AuthenticatorDuoStageRequest to an JSON string
   *
   * @return JSON string
   */
