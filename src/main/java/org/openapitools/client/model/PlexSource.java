...
public class PlexSource {
  ...
  public PlexSource name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PlexSource slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public PlexSource enabled(Boolean enabled) {
  ...
  public PlexSource authenticationFlow(UUID authenticationFlow) {
  ...
  public PlexSource enrollmentFlow(UUID enrollmentFlow) {
  ...
  public PlexSource policyEngineMode(PolicyEngineMode policyEngineMode) {
  ...
  public PlexSource userMatchingMode(UserMatchingModeEnum userMatchingMode) {
  ...
  public PlexSource userPathTemplate(String userPathTemplate) {
  ...
  public PlexSource clientId(String clientId) {
  ...
  public PlexSource allowedServers(List<String> allowedServers) {
    this.allowedServers = allowedServers;
    return this;
  }

  public PlexSource addAllowedServersItem(String allowedServersItem) {
  ...
  public PlexSource allowFriends(Boolean allowFriends) {
  ...
  public PlexSource plexToken(String plexToken) {
  ...
  public boolean equals(Object o) {
    ...
    PlexSource plexSource = (PlexSource) o;
    return Objects.equals(this.pk, plexSource.pk) &&
        Objects.equals(this.name, plexSource.name) &&
        Objects.equals(this.slug, plexSource.slug) &&
        Objects.equals(this.enabled, plexSource.enabled) &&
        Objects.equals(this.authenticationFlow, plexSource.authenticationFlow) &&
        Objects.equals(this.enrollmentFlow, plexSource.enrollmentFlow) &&
        Objects.equals(this.component, plexSource.component) &&
        Objects.equals(this.verboseName, plexSource.verboseName) &&
        Objects.equals(this.verboseNamePlural, plexSource.verboseNamePlural) &&
        Objects.equals(this.metaModelName, plexSource.metaModelName) &&
        Objects.equals(this.policyEngineMode, plexSource.policyEngineMode) &&
        Objects.equals(this.userMatchingMode, plexSource.userMatchingMode) &&
        Objects.equals(this.managed, plexSource.managed) &&
        Objects.equals(this.userPathTemplate, plexSource.userPathTemplate) &&
        Objects.equals(this.icon, plexSource.icon) &&
        Objects.equals(this.clientId, plexSource.clientId) &&
        Objects.equals(this.allowedServers, plexSource.allowedServers) &&
        Objects.equals(this.allowFriends, plexSource.allowFriends) &&
        Objects.equals(this.plexToken, plexSource.plexToken);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pk, name, slug, enabled, authenticationFlow, enrollmentFlow, component, verboseName, verboseNamePlural, metaModelName, policyEngineMode, userMatchingMode, managed, userPathTemplate, icon, clientId, allowedServers, allowFriends, plexToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlexSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlexSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlexSource is not found in the empty JSON string", PlexSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlexSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlexSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlexSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlexSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlexSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlexSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlexSource.class));

       return (TypeAdapter<T>) new TypeAdapter<PlexSource>() {
           @Override
           public void write(JsonWriter out, PlexSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlexSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlexSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlexSource
   * @throws IOException if the JSON string is invalid with respect to PlexSource
   */
  public static PlexSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlexSource.class);
  }

  /**
   * Convert an instance of PlexSource to an JSON string
   *
   * @return JSON string
   */
