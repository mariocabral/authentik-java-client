...
public class LoginMetrics {
  ...
  public boolean equals(Object o) {
    ...
    LoginMetrics loginMetrics = (LoginMetrics) o;
    return Objects.equals(this.logins, loginMetrics.logins) &&
        Objects.equals(this.loginsFailed, loginMetrics.loginsFailed) &&
        Objects.equals(this.authorizations, loginMetrics.authorizations);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoginMetrics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoginMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoginMetrics is not found in the empty JSON string", LoginMetrics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoginMetrics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoginMetrics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoginMetrics.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoginMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoginMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoginMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoginMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<LoginMetrics>() {
           @Override
           public void write(JsonWriter out, LoginMetrics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoginMetrics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoginMetrics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoginMetrics
   * @throws IOException if the JSON string is invalid with respect to LoginMetrics
   */
  public static LoginMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoginMetrics.class);
  }

  /**
   * Convert an instance of LoginMetrics to an JSON string
   *
   * @return JSON string
   */
