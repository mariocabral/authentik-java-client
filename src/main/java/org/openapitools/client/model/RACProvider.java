...
public class RACProvider {
  ...
  public RACProvider name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RACProvider authenticationFlow(UUID authenticationFlow) {
  ...
  public RACProvider authorizationFlow(UUID authorizationFlow) {
  ...
  public RACProvider propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public RACProvider addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public RACProvider settings(Object settings) {
  ...
  public RACProvider connectionExpiry(String connectionExpiry) {
  ...
  public RACProvider deleteTokenOnDisconnect(Boolean deleteTokenOnDisconnect) {
  ...
  public boolean equals(Object o) {
    ...
    RACProvider raCProvider = (RACProvider) o;
    return Objects.equals(this.pk, raCProvider.pk) &&
        Objects.equals(this.name, raCProvider.name) &&
        Objects.equals(this.authenticationFlow, raCProvider.authenticationFlow) &&
        Objects.equals(this.authorizationFlow, raCProvider.authorizationFlow) &&
        Objects.equals(this.propertyMappings, raCProvider.propertyMappings) &&
        Objects.equals(this.component, raCProvider.component) &&
        Objects.equals(this.assignedApplicationSlug, raCProvider.assignedApplicationSlug) &&
        Objects.equals(this.assignedApplicationName, raCProvider.assignedApplicationName) &&
        Objects.equals(this.assignedBackchannelApplicationSlug, raCProvider.assignedBackchannelApplicationSlug) &&
        Objects.equals(this.assignedBackchannelApplicationName, raCProvider.assignedBackchannelApplicationName) &&
        Objects.equals(this.verboseName, raCProvider.verboseName) &&
        Objects.equals(this.verboseNamePlural, raCProvider.verboseNamePlural) &&
        Objects.equals(this.metaModelName, raCProvider.metaModelName) &&
        Objects.equals(this.settings, raCProvider.settings) &&
        Objects.equals(this.outpostSet, raCProvider.outpostSet) &&
        Objects.equals(this.connectionExpiry, raCProvider.connectionExpiry) &&
        Objects.equals(this.deleteTokenOnDisconnect, raCProvider.deleteTokenOnDisconnect);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pk, name, authenticationFlow, authorizationFlow, propertyMappings, component, assignedApplicationSlug, assignedApplicationName, assignedBackchannelApplicationSlug, assignedBackchannelApplicationName, verboseName, verboseNamePlural, metaModelName, settings, outpostSet, connectionExpiry, deleteTokenOnDisconnect);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RACProvider
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RACProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RACProvider is not found in the empty JSON string", RACProvider.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RACProvider.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RACProvider` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RACProvider.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RACProvider.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RACProvider' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RACProvider> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RACProvider.class));

       return (TypeAdapter<T>) new TypeAdapter<RACProvider>() {
           @Override
           public void write(JsonWriter out, RACProvider value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RACProvider read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RACProvider given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RACProvider
   * @throws IOException if the JSON string is invalid with respect to RACProvider
   */
  public static RACProvider fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RACProvider.class);
  }

  /**
   * Convert an instance of RACProvider to an JSON string
   *
   * @return JSON string
   */
