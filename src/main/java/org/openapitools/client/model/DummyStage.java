...
public class DummyStage {
  ...
  public DummyStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DummyStage flowSet(List<FlowSet> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public DummyStage addFlowSetItem(FlowSet flowSetItem) {
  ...
  public DummyStage throwError(Boolean throwError) {
  ...
  public boolean equals(Object o) {
    ...
    DummyStage dummyStage = (DummyStage) o;
    return Objects.equals(this.pk, dummyStage.pk) &&
        Objects.equals(this.name, dummyStage.name) &&
        Objects.equals(this.component, dummyStage.component) &&
        Objects.equals(this.verboseName, dummyStage.verboseName) &&
        Objects.equals(this.verboseNamePlural, dummyStage.verboseNamePlural) &&
        Objects.equals(this.metaModelName, dummyStage.metaModelName) &&
        Objects.equals(this.flowSet, dummyStage.flowSet) &&
        Objects.equals(this.throwError, dummyStage.throwError);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pk, name, component, verboseName, verboseNamePlural, metaModelName, flowSet, throwError);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DummyStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DummyStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DummyStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DummyStage is not found in the empty JSON string", DummyStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DummyStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DummyStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DummyStage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DummyStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DummyStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DummyStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DummyStage.class));

       return (TypeAdapter<T>) new TypeAdapter<DummyStage>() {
           @Override
           public void write(JsonWriter out, DummyStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DummyStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DummyStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DummyStage
   * @throws IOException if the JSON string is invalid with respect to DummyStage
   */
  public static DummyStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DummyStage.class);
  }

  /**
   * Convert an instance of DummyStage to an JSON string
   *
   * @return JSON string
   */
