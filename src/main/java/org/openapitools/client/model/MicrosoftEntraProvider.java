...
public class MicrosoftEntraProvider {
  ...
  public MicrosoftEntraProvider name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MicrosoftEntraProvider propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public MicrosoftEntraProvider addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public MicrosoftEntraProvider propertyMappingsGroup(List<UUID> propertyMappingsGroup) {
    this.propertyMappingsGroup = propertyMappingsGroup;
    return this;
  }

  public MicrosoftEntraProvider addPropertyMappingsGroupItem(UUID propertyMappingsGroupItem) {
  ...
  public MicrosoftEntraProvider clientId(String clientId) {
  ...
  public MicrosoftEntraProvider clientSecret(String clientSecret) {
  ...
  public MicrosoftEntraProvider tenantId(String tenantId) {
  ...
  public MicrosoftEntraProvider excludeUsersServiceAccount(Boolean excludeUsersServiceAccount) {
  ...
  public MicrosoftEntraProvider filterGroup(UUID filterGroup) {
  ...
  public MicrosoftEntraProvider userDeleteAction(OutgoingSyncDeleteAction userDeleteAction) {
  ...
  public MicrosoftEntraProvider groupDeleteAction(OutgoingSyncDeleteAction groupDeleteAction) {
  ...
  public boolean equals(Object o) {
    ...
    MicrosoftEntraProvider microsoftEntraProvider = (MicrosoftEntraProvider) o;
    return Objects.equals(this.pk, microsoftEntraProvider.pk) &&
        Objects.equals(this.name, microsoftEntraProvider.name) &&
        Objects.equals(this.propertyMappings, microsoftEntraProvider.propertyMappings) &&
        Objects.equals(this.propertyMappingsGroup, microsoftEntraProvider.propertyMappingsGroup) &&
        Objects.equals(this.component, microsoftEntraProvider.component) &&
        Objects.equals(this.assignedBackchannelApplicationSlug, microsoftEntraProvider.assignedBackchannelApplicationSlug) &&
        Objects.equals(this.assignedBackchannelApplicationName, microsoftEntraProvider.assignedBackchannelApplicationName) &&
        Objects.equals(this.verboseName, microsoftEntraProvider.verboseName) &&
        Objects.equals(this.verboseNamePlural, microsoftEntraProvider.verboseNamePlural) &&
        Objects.equals(this.metaModelName, microsoftEntraProvider.metaModelName) &&
        Objects.equals(this.clientId, microsoftEntraProvider.clientId) &&
        Objects.equals(this.clientSecret, microsoftEntraProvider.clientSecret) &&
        Objects.equals(this.tenantId, microsoftEntraProvider.tenantId) &&
        Objects.equals(this.excludeUsersServiceAccount, microsoftEntraProvider.excludeUsersServiceAccount) &&
        Objects.equals(this.filterGroup, microsoftEntraProvider.filterGroup) &&
        Objects.equals(this.userDeleteAction, microsoftEntraProvider.userDeleteAction) &&
        Objects.equals(this.groupDeleteAction, microsoftEntraProvider.groupDeleteAction);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pk, name, propertyMappings, propertyMappingsGroup, component, assignedBackchannelApplicationSlug, assignedBackchannelApplicationName, verboseName, verboseNamePlural, metaModelName, clientId, clientSecret, tenantId, excludeUsersServiceAccount, filterGroup, userDeleteAction, groupDeleteAction);
  }
  ...
  public String toString() {
    ...
    sb.append("class MicrosoftEntraProvider {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MicrosoftEntraProvider
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MicrosoftEntraProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MicrosoftEntraProvider is not found in the empty JSON string", MicrosoftEntraProvider.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MicrosoftEntraProvider.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MicrosoftEntraProvider` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MicrosoftEntraProvider.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MicrosoftEntraProvider.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MicrosoftEntraProvider' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MicrosoftEntraProvider> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MicrosoftEntraProvider.class));

       return (TypeAdapter<T>) new TypeAdapter<MicrosoftEntraProvider>() {
           @Override
           public void write(JsonWriter out, MicrosoftEntraProvider value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MicrosoftEntraProvider read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MicrosoftEntraProvider given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MicrosoftEntraProvider
   * @throws IOException if the JSON string is invalid with respect to MicrosoftEntraProvider
   */
  public static MicrosoftEntraProvider fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MicrosoftEntraProvider.class);
  }

  /**
   * Convert an instance of MicrosoftEntraProvider to an JSON string
   *
   * @return JSON string
   */
