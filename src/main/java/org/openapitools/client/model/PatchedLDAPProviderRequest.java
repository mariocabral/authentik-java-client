...
public class PatchedLDAPProviderRequest {
  ...
  public PatchedLDAPProviderRequest() {
  }

  public PatchedLDAPProviderRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PatchedLDAPProviderRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public PatchedLDAPProviderRequest authorizationFlow(UUID authorizationFlow) {
  ...
  public PatchedLDAPProviderRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public PatchedLDAPProviderRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public PatchedLDAPProviderRequest baseDn(String baseDn) {
    this.baseDn = baseDn;
    return this;
  }
  ...
  public PatchedLDAPProviderRequest searchGroup(UUID searchGroup) {
  ...
  public PatchedLDAPProviderRequest certificate(UUID certificate) {
  ...
  public PatchedLDAPProviderRequest tlsServerName(String tlsServerName) {
  ...
  public PatchedLDAPProviderRequest uidStartNumber(Integer uidStartNumber) {
  ...
  public PatchedLDAPProviderRequest gidStartNumber(Integer gidStartNumber) {
  ...
  public PatchedLDAPProviderRequest searchMode(LDAPAPIAccessMode searchMode) {
  ...
  public PatchedLDAPProviderRequest bindMode(LDAPAPIAccessMode bindMode) {
  ...
  public PatchedLDAPProviderRequest mfaSupport(Boolean mfaSupport) {
  ...
  public boolean equals(Object o) {
    ...
    PatchedLDAPProviderRequest patchedLDAPProviderRequest = (PatchedLDAPProviderRequest) o;
    return Objects.equals(this.name, patchedLDAPProviderRequest.name) &&
        Objects.equals(this.authenticationFlow, patchedLDAPProviderRequest.authenticationFlow) &&
        Objects.equals(this.authorizationFlow, patchedLDAPProviderRequest.authorizationFlow) &&
        Objects.equals(this.propertyMappings, patchedLDAPProviderRequest.propertyMappings) &&
        Objects.equals(this.baseDn, patchedLDAPProviderRequest.baseDn) &&
        Objects.equals(this.searchGroup, patchedLDAPProviderRequest.searchGroup) &&
        Objects.equals(this.certificate, patchedLDAPProviderRequest.certificate) &&
        Objects.equals(this.tlsServerName, patchedLDAPProviderRequest.tlsServerName) &&
        Objects.equals(this.uidStartNumber, patchedLDAPProviderRequest.uidStartNumber) &&
        Objects.equals(this.gidStartNumber, patchedLDAPProviderRequest.gidStartNumber) &&
        Objects.equals(this.searchMode, patchedLDAPProviderRequest.searchMode) &&
        Objects.equals(this.bindMode, patchedLDAPProviderRequest.bindMode) &&
        Objects.equals(this.mfaSupport, patchedLDAPProviderRequest.mfaSupport);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedLDAPProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchedLDAPProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchedLDAPProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchedLDAPProviderRequest is not found in the empty JSON string", PatchedLDAPProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchedLDAPProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchedLDAPProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchedLDAPProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchedLDAPProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchedLDAPProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchedLDAPProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchedLDAPProviderRequest>() {
           @Override
           public void write(JsonWriter out, PatchedLDAPProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchedLDAPProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchedLDAPProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchedLDAPProviderRequest
   * @throws IOException if the JSON string is invalid with respect to PatchedLDAPProviderRequest
   */
  public static PatchedLDAPProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchedLDAPProviderRequest.class);
  }

  /**
   * Convert an instance of PatchedLDAPProviderRequest to an JSON string
   *
   * @return JSON string
   */
