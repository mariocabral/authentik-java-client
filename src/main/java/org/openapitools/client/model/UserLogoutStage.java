...
public class UserLogoutStage {
  ...
  public UserLogoutStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UserLogoutStage flowSet(List<FlowSet> flowSet) {
    this.flowSet = flowSet;
    return this;
  }

  public UserLogoutStage addFlowSetItem(FlowSet flowSetItem) {
  ...
  public boolean equals(Object o) {
    ...
    UserLogoutStage userLogoutStage = (UserLogoutStage) o;
    return Objects.equals(this.pk, userLogoutStage.pk) &&
        Objects.equals(this.name, userLogoutStage.name) &&
        Objects.equals(this.component, userLogoutStage.component) &&
        Objects.equals(this.verboseName, userLogoutStage.verboseName) &&
        Objects.equals(this.verboseNamePlural, userLogoutStage.verboseNamePlural) &&
        Objects.equals(this.metaModelName, userLogoutStage.metaModelName) &&
        Objects.equals(this.flowSet, userLogoutStage.flowSet);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserLogoutStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserLogoutStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserLogoutStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserLogoutStage is not found in the empty JSON string", UserLogoutStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserLogoutStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserLogoutStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserLogoutStage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserLogoutStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserLogoutStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserLogoutStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserLogoutStage.class));

       return (TypeAdapter<T>) new TypeAdapter<UserLogoutStage>() {
           @Override
           public void write(JsonWriter out, UserLogoutStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserLogoutStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserLogoutStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserLogoutStage
   * @throws IOException if the JSON string is invalid with respect to UserLogoutStage
   */
  public static UserLogoutStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserLogoutStage.class);
  }

  /**
   * Convert an instance of UserLogoutStage to an JSON string
   *
   * @return JSON string
   */
