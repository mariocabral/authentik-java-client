...
public class PatchedSAMLProviderRequest {
  ...
  public PatchedSAMLProviderRequest() {
  }

  public PatchedSAMLProviderRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PatchedSAMLProviderRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public PatchedSAMLProviderRequest authorizationFlow(UUID authorizationFlow) {
  ...
  public PatchedSAMLProviderRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public PatchedSAMLProviderRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public PatchedSAMLProviderRequest acsUrl(URI acsUrl) {
    this.acsUrl = acsUrl;
    return this;
  }
  ...
  public PatchedSAMLProviderRequest audience(String audience) {
  ...
  public PatchedSAMLProviderRequest issuer(String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public PatchedSAMLProviderRequest assertionValidNotBefore(String assertionValidNotBefore) {
  ...
  public PatchedSAMLProviderRequest assertionValidNotOnOrAfter(String assertionValidNotOnOrAfter) {
  ...
  public PatchedSAMLProviderRequest sessionValidNotOnOrAfter(String sessionValidNotOnOrAfter) {
  ...
  public PatchedSAMLProviderRequest nameIdMapping(UUID nameIdMapping) {
  ...
  public PatchedSAMLProviderRequest digestAlgorithm(DigestAlgorithmEnum digestAlgorithm) {
  ...
  public PatchedSAMLProviderRequest signatureAlgorithm(SignatureAlgorithmEnum signatureAlgorithm) {
  ...
  public PatchedSAMLProviderRequest signingKp(UUID signingKp) {
  ...
  public PatchedSAMLProviderRequest verificationKp(UUID verificationKp) {
  ...
  public PatchedSAMLProviderRequest spBinding(SpBindingEnum spBinding) {
  ...
  public PatchedSAMLProviderRequest defaultRelayState(String defaultRelayState) {
  ...
  public boolean equals(Object o) {
    ...
    PatchedSAMLProviderRequest patchedSAMLProviderRequest = (PatchedSAMLProviderRequest) o;
    return Objects.equals(this.name, patchedSAMLProviderRequest.name) &&
        Objects.equals(this.authenticationFlow, patchedSAMLProviderRequest.authenticationFlow) &&
        Objects.equals(this.authorizationFlow, patchedSAMLProviderRequest.authorizationFlow) &&
        Objects.equals(this.propertyMappings, patchedSAMLProviderRequest.propertyMappings) &&
        Objects.equals(this.acsUrl, patchedSAMLProviderRequest.acsUrl) &&
        Objects.equals(this.audience, patchedSAMLProviderRequest.audience) &&
        Objects.equals(this.issuer, patchedSAMLProviderRequest.issuer) &&
        Objects.equals(this.assertionValidNotBefore, patchedSAMLProviderRequest.assertionValidNotBefore) &&
        Objects.equals(this.assertionValidNotOnOrAfter, patchedSAMLProviderRequest.assertionValidNotOnOrAfter) &&
        Objects.equals(this.sessionValidNotOnOrAfter, patchedSAMLProviderRequest.sessionValidNotOnOrAfter) &&
        Objects.equals(this.nameIdMapping, patchedSAMLProviderRequest.nameIdMapping) &&
        Objects.equals(this.digestAlgorithm, patchedSAMLProviderRequest.digestAlgorithm) &&
        Objects.equals(this.signatureAlgorithm, patchedSAMLProviderRequest.signatureAlgorithm) &&
        Objects.equals(this.signingKp, patchedSAMLProviderRequest.signingKp) &&
        Objects.equals(this.verificationKp, patchedSAMLProviderRequest.verificationKp) &&
        Objects.equals(this.spBinding, patchedSAMLProviderRequest.spBinding) &&
        Objects.equals(this.defaultRelayState, patchedSAMLProviderRequest.defaultRelayState);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedSAMLProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchedSAMLProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchedSAMLProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchedSAMLProviderRequest is not found in the empty JSON string", PatchedSAMLProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchedSAMLProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchedSAMLProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchedSAMLProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchedSAMLProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchedSAMLProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchedSAMLProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchedSAMLProviderRequest>() {
           @Override
           public void write(JsonWriter out, PatchedSAMLProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchedSAMLProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchedSAMLProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchedSAMLProviderRequest
   * @throws IOException if the JSON string is invalid with respect to PatchedSAMLProviderRequest
   */
  public static PatchedSAMLProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchedSAMLProviderRequest.class);
  }

  /**
   * Convert an instance of PatchedSAMLProviderRequest to an JSON string
   *
   * @return JSON string
   */
