...
public class UserLoginChallenge {
  ...
  public UserLoginChallenge() {
  }

  public UserLoginChallenge type(ChallengeChoices type) {
    this.type = type;
    return this;
  }
  ...
  public UserLoginChallenge flowInfo(ContextualFlowInfo flowInfo) {
  ...
  public UserLoginChallenge component(String component) {
  ...
  public UserLoginChallenge responseErrors(Map<String, List<ErrorDetail>> responseErrors) {
    this.responseErrors = responseErrors;
    return this;
  }

  public UserLoginChallenge putResponseErrorsItem(String key, List<ErrorDetail> responseErrorsItem) {
  ...
  public UserLoginChallenge pendingUser(String pendingUser) {
  ...
  public UserLoginChallenge pendingUserAvatar(String pendingUserAvatar) {
  ...
  public boolean equals(Object o) {
    ...
    UserLoginChallenge userLoginChallenge = (UserLoginChallenge) o;
    return Objects.equals(this.type, userLoginChallenge.type) &&
        Objects.equals(this.flowInfo, userLoginChallenge.flowInfo) &&
        Objects.equals(this.component, userLoginChallenge.component) &&
        Objects.equals(this.responseErrors, userLoginChallenge.responseErrors) &&
        Objects.equals(this.pendingUser, userLoginChallenge.pendingUser) &&
        Objects.equals(this.pendingUserAvatar, userLoginChallenge.pendingUserAvatar);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, flowInfo, component, responseErrors, pendingUser, pendingUserAvatar);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserLoginChallenge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserLoginChallenge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserLoginChallenge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserLoginChallenge is not found in the empty JSON string", UserLoginChallenge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserLoginChallenge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserLoginChallenge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserLoginChallenge.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserLoginChallenge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserLoginChallenge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserLoginChallenge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserLoginChallenge.class));

       return (TypeAdapter<T>) new TypeAdapter<UserLoginChallenge>() {
           @Override
           public void write(JsonWriter out, UserLoginChallenge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserLoginChallenge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserLoginChallenge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserLoginChallenge
   * @throws IOException if the JSON string is invalid with respect to UserLoginChallenge
   */
  public static UserLoginChallenge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserLoginChallenge.class);
  }

  /**
   * Convert an instance of UserLoginChallenge to an JSON string
   *
   * @return JSON string
   */
