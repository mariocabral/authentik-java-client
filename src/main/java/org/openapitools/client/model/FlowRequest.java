...
public class FlowRequest {
  ...
  public FlowRequest slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public FlowRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public FlowRequest designation(FlowDesignationEnum designation) {
  ...
  public FlowRequest policyEngineMode(PolicyEngineMode policyEngineMode) {
  ...
  public FlowRequest compatibilityMode(Boolean compatibilityMode) {
  ...
  public FlowRequest layout(FlowLayoutEnum layout) {
    this.layout = layout;
    return this;
  }
  ...
  public FlowRequest deniedAction(DeniedActionEnum deniedAction) {
  ...
  public FlowRequest authentication(AuthenticationEnum authentication) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, flowRequest.name) &&
        Objects.equals(this.slug, flowRequest.slug) &&
        Objects.equals(this.title, flowRequest.title) &&
        Objects.equals(this.designation, flowRequest.designation) &&
        Objects.equals(this.policyEngineMode, flowRequest.policyEngineMode) &&
        Objects.equals(this.compatibilityMode, flowRequest.compatibilityMode) &&
        Objects.equals(this.layout, flowRequest.layout) &&
        Objects.equals(this.deniedAction, flowRequest.deniedAction) &&
        Objects.equals(this.authentication, flowRequest.authentication);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlowRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlowRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FlowRequest is not found in the empty JSON string", FlowRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlowRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlowRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlowRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlowRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlowRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlowRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlowRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FlowRequest>() {
           @Override
           public void write(JsonWriter out, FlowRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FlowRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FlowRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlowRequest
   * @throws IOException if the JSON string is invalid with respect to FlowRequest
   */
  public static FlowRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlowRequest.class);
  }

  /**
   * Convert an instance of FlowRequest to an JSON string
   *
   * @return JSON string
   */
