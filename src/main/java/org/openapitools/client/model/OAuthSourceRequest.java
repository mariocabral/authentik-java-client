...
public class OAuthSourceRequest {
  ...
  public OAuthSourceRequest() {
  }

  public OAuthSourceRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public OAuthSourceRequest slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public OAuthSourceRequest enabled(Boolean enabled) {
  ...
  public OAuthSourceRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public OAuthSourceRequest enrollmentFlow(UUID enrollmentFlow) {
  ...
  public OAuthSourceRequest policyEngineMode(PolicyEngineMode policyEngineMode) {
  ...
  public OAuthSourceRequest userMatchingMode(UserMatchingModeEnum userMatchingMode) {
  ...
  public OAuthSourceRequest userPathTemplate(String userPathTemplate) {
  ...
  public OAuthSourceRequest providerType(ProviderTypeEnum providerType) {
  ...
  public OAuthSourceRequest requestTokenUrl(String requestTokenUrl) {
  ...
  public OAuthSourceRequest authorizationUrl(String authorizationUrl) {
  ...
  public OAuthSourceRequest accessTokenUrl(String accessTokenUrl) {
  ...
  public OAuthSourceRequest profileUrl(String profileUrl) {
  ...
  public OAuthSourceRequest consumerKey(String consumerKey) {
  ...
  public OAuthSourceRequest consumerSecret(String consumerSecret) {
  ...
  public OAuthSourceRequest additionalScopes(String additionalScopes) {
  ...
  public OAuthSourceRequest oidcWellKnownUrl(String oidcWellKnownUrl) {
  ...
  public OAuthSourceRequest oidcJwksUrl(String oidcJwksUrl) {
  ...
  public OAuthSourceRequest oidcJwks(Object oidcJwks) {
  ...
  public boolean equals(Object o) {
    ...
    OAuthSourceRequest oauthSourceRequest = (OAuthSourceRequest) o;
    return Objects.equals(this.name, oauthSourceRequest.name) &&
        Objects.equals(this.slug, oauthSourceRequest.slug) &&
        Objects.equals(this.enabled, oauthSourceRequest.enabled) &&
        Objects.equals(this.authenticationFlow, oauthSourceRequest.authenticationFlow) &&
        Objects.equals(this.enrollmentFlow, oauthSourceRequest.enrollmentFlow) &&
        Objects.equals(this.policyEngineMode, oauthSourceRequest.policyEngineMode) &&
        Objects.equals(this.userMatchingMode, oauthSourceRequest.userMatchingMode) &&
        Objects.equals(this.userPathTemplate, oauthSourceRequest.userPathTemplate) &&
        Objects.equals(this.providerType, oauthSourceRequest.providerType) &&
        Objects.equals(this.requestTokenUrl, oauthSourceRequest.requestTokenUrl) &&
        Objects.equals(this.authorizationUrl, oauthSourceRequest.authorizationUrl) &&
        Objects.equals(this.accessTokenUrl, oauthSourceRequest.accessTokenUrl) &&
        Objects.equals(this.profileUrl, oauthSourceRequest.profileUrl) &&
        Objects.equals(this.consumerKey, oauthSourceRequest.consumerKey) &&
        Objects.equals(this.consumerSecret, oauthSourceRequest.consumerSecret) &&
        Objects.equals(this.additionalScopes, oauthSourceRequest.additionalScopes) &&
        Objects.equals(this.oidcWellKnownUrl, oauthSourceRequest.oidcWellKnownUrl) &&
        Objects.equals(this.oidcJwksUrl, oauthSourceRequest.oidcJwksUrl) &&
        Objects.equals(this.oidcJwks, oauthSourceRequest.oidcJwks);
  }
  ...
  public String toString() {
    ...
    sb.append("class OAuthSourceRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("consumer_secret");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OAuthSourceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OAuthSourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OAuthSourceRequest is not found in the empty JSON string", OAuthSourceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OAuthSourceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OAuthSourceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OAuthSourceRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("consumer_secret").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OAuthSourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OAuthSourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OAuthSourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OAuthSourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OAuthSourceRequest>() {
           @Override
           public void write(JsonWriter out, OAuthSourceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OAuthSourceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OAuthSourceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OAuthSourceRequest
   * @throws IOException if the JSON string is invalid with respect to OAuthSourceRequest
   */
  public static OAuthSourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OAuthSourceRequest.class);
  }

  /**
   * Convert an instance of OAuthSourceRequest to an JSON string
   *
   * @return JSON string
   */
