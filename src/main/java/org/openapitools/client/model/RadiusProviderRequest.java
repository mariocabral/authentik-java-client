...
public class RadiusProviderRequest {
  ...
  public RadiusProviderRequest() {
  }

  public RadiusProviderRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RadiusProviderRequest authenticationFlow(UUID authenticationFlow) {
  ...
  public RadiusProviderRequest authorizationFlow(UUID authorizationFlow) {
  ...
  public RadiusProviderRequest propertyMappings(List<UUID> propertyMappings) {
    this.propertyMappings = propertyMappings;
    return this;
  }

  public RadiusProviderRequest addPropertyMappingsItem(UUID propertyMappingsItem) {
  ...
  public RadiusProviderRequest clientNetworks(String clientNetworks) {
  ...
  public RadiusProviderRequest sharedSecret(String sharedSecret) {
  ...
  public RadiusProviderRequest mfaSupport(Boolean mfaSupport) {
  ...
  public boolean equals(Object o) {
    ...
    RadiusProviderRequest radiusProviderRequest = (RadiusProviderRequest) o;
    return Objects.equals(this.name, radiusProviderRequest.name) &&
        Objects.equals(this.authenticationFlow, radiusProviderRequest.authenticationFlow) &&
        Objects.equals(this.authorizationFlow, radiusProviderRequest.authorizationFlow) &&
        Objects.equals(this.propertyMappings, radiusProviderRequest.propertyMappings) &&
        Objects.equals(this.clientNetworks, radiusProviderRequest.clientNetworks) &&
        Objects.equals(this.sharedSecret, radiusProviderRequest.sharedSecret) &&
        Objects.equals(this.mfaSupport, radiusProviderRequest.mfaSupport);
  }
  ...
  public String toString() {
    ...
    sb.append("class RadiusProviderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RadiusProviderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RadiusProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RadiusProviderRequest is not found in the empty JSON string", RadiusProviderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RadiusProviderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RadiusProviderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RadiusProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RadiusProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RadiusProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RadiusProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RadiusProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RadiusProviderRequest>() {
           @Override
           public void write(JsonWriter out, RadiusProviderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RadiusProviderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RadiusProviderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RadiusProviderRequest
   * @throws IOException if the JSON string is invalid with respect to RadiusProviderRequest
   */
  public static RadiusProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RadiusProviderRequest.class);
  }

  /**
   * Convert an instance of RadiusProviderRequest to an JSON string
   *
   * @return JSON string
   */
