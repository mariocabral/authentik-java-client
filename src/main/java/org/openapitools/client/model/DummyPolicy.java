...
public class DummyPolicy {
  ...
  public DummyPolicy name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DummyPolicy executionLogging(Boolean executionLogging) {
  ...
  public DummyPolicy result(Boolean result) {
    this.result = result;
    return this;
  }
  ...
  public DummyPolicy waitMin(Integer waitMin) {
  ...
  public DummyPolicy waitMax(Integer waitMax) {
  ...
  public boolean equals(Object o) {
    ...
    DummyPolicy dummyPolicy = (DummyPolicy) o;
    return Objects.equals(this.pk, dummyPolicy.pk) &&
        Objects.equals(this.name, dummyPolicy.name) &&
        Objects.equals(this.executionLogging, dummyPolicy.executionLogging) &&
        Objects.equals(this.component, dummyPolicy.component) &&
        Objects.equals(this.verboseName, dummyPolicy.verboseName) &&
        Objects.equals(this.verboseNamePlural, dummyPolicy.verboseNamePlural) &&
        Objects.equals(this.metaModelName, dummyPolicy.metaModelName) &&
        Objects.equals(this.boundTo, dummyPolicy.boundTo) &&
        Objects.equals(this.result, dummyPolicy.result) &&
        Objects.equals(this.waitMin, dummyPolicy.waitMin) &&
        Objects.equals(this.waitMax, dummyPolicy.waitMax);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pk, name, executionLogging, component, verboseName, verboseNamePlural, metaModelName, boundTo, result, waitMin, waitMax);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DummyPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DummyPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DummyPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DummyPolicy is not found in the empty JSON string", DummyPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DummyPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DummyPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DummyPolicy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DummyPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DummyPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DummyPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DummyPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<DummyPolicy>() {
           @Override
           public void write(JsonWriter out, DummyPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DummyPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DummyPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DummyPolicy
   * @throws IOException if the JSON string is invalid with respect to DummyPolicy
   */
  public static DummyPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DummyPolicy.class);
  }

  /**
   * Convert an instance of DummyPolicy to an JSON string
   *
   * @return JSON string
   */
